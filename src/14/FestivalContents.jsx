      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 border rounded-2xl shadow-sm bg-white border-gray-200 p-5">
          <div className="w-full grid grid-cols-1 md:grid-cols-6 gap-2">
              ...
              <div className="font-bold text-lg md:col-span-5 p-2">{contents.GUGUN_NM}</div>
              <div className="p-2 md:text-right">주소</div>
              <div className="font-bold text-lg md:col-span-5 p-2">{contents.ADDR1}</div>
              <div className="p-2 md:text-right">연락처</div>
              <div className="font-bold text-lg md:col-span-5 p-2">{contents.CNTCT_TEL}</div>
              <div className="p-2 md:text-right">홈페이지 </div>
              <div className="font-bold text-lg md:col-span-5 p-2">{contents.HOMEPAGE_URL}</div>
              <div className="p-2 md:text-right">상세내용 </div>
              <div className="font-bold text-lg md:col-span-5 p-2">{contents.ITEMCNTNTS}</div>
          </div>
        </div>
      </div>
